...
function dealActivity(shopActivityList, indexNowPrice, newDishList, actFoods) { //活动集合,原总价,已点菜品集合
            ...
            if (_activityOrder[i].bargainCls == 1) {
                ...
                if (_activityBuygiftItemList) {//判断对象是否存在
                    _activityBuygiftItemList.forEach(function (item, index) {
                        ...
                        console.log("*************满足 打造爆款活动********");
                        if (_kind == 301) {//301=买几赠几(变价)
                            console.log("*************类型编号301********");
