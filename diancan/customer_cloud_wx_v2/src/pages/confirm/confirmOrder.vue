        ...
        if (item.isShowUnit == 0) {
          item.menuItemUnitList.forEach(attr => {
            ...
            if (attr.count) {
              ...
              console.log("菜品的原价(有条件):"+attr.fdsaleprice);
              dish.sendPrice = attr.fdsaleprice;
          ...
          console.log("菜品的原价(无条件):"+item.menuItemUnitList[0].fdsaleprice);
          dish.sendPrice = item.menuItemUnitList[0].fdsaleprice;
