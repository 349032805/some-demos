...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${static('/bower_components/angular-ui-tree/dist/angular-ui-tree.min.css')}" />
    <link rel="stylesheet" type="text/css" href="${static('/bower_components/AngularJS-Toaster/toaster.min.css')}" />
</head>
<body>
<header id="header_tab" class="navbar-inverse bs-docs-nav" style="position: fixed; z-index: 1000;  width: 100%; height: auto; margin-top: 0px; padding: 0px; top:0px;" role="banner" ng-controller="index.Index">
...
<div id="modal-server-error" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" style="z-index: 1060;">
...
<div class="clearfix">
    <div class="modal fade" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" id="errorRemindDialog" role="dialog" style="z-index: 1050;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="clearfix">
    <div class="modal fade" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" id="global_SuccessRemindDialog" role="dialog" style="z-index: 1050;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="false">
...
<div class="modal fade" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" id="global_Event_ConfirmDialog" role="dialog" style="z-index: 1040;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="false">
            ...
            <div id="global_dialog_confirm_errorInfo" class="deletePartnerErrorInfo"></div>
            <div class="modal-footer">
                <div class="col-xs-offset-7 col-md-offset-7">
                    <button type="button" class="col-xs-5 col-md-5 col-xs-offset-1 col-md-offset-1 btn btn-primary" id="global_dialog_confirm_click" >
                        确认
                    </button>
...
<div class="clearfix">
    <div class="modal fade" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" id="global_dialog_uploadImageDialog" role="dialog" style="z-index: 1040;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="" enctype="multipart/form-data" id="global_dialog_uploadImageDialogForm" name="global_dialog_uploadImageDialogForm">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="false">
                            &times;
                        </button>
                    ...
                    <div class="modal-footer">
                        <div class="col-xs-offset-7 col-md-offset-7">
                            <button type="button" class="col-xs-5 col-md-5 col-xs-offset-1 col-md-offset-1 btn btn-default" data-dismiss="modal">
                                取消
                            </button>
                            <button type="button" id="global_dialog_ImageUploadClick" class="col-xs-5 col-md-5 btn btn-primary">
                                确认
                            </button>
                        </div>
                    </div>
...
<script type="text/javascript" src="${static('/scripts/libs/Markdown.Editor.js')}"></script>
