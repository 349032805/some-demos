 ...
 */
public class JSONEditorTokener {
    ...
    public JSONEditorTokener(Reader reader) {
    ...
    public JSONEditorTokener(InputStream inputStream) throws JSONException {
        this((Reader)(new InputStreamReader(inputStream)));
    }

    public JSONEditorTokener(String s) {
    ...
    public Object nextValue() throws JSONException {
        ...
        switch(c) {
            ...
            case '[':
                this.back();
                return new JSONEditorArray(this);
            case '{':
                this.back();
                return new JSONEditorObject(this);
            default:
                StringBuffer sb;
                ...
                if("".equals(string)) {
                    ...
                    return JSONEditorObject.stringToValue(string);
                }
        }
    }
