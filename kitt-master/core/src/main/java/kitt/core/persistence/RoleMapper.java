...
public interface RoleMapper {
    ...
    @Insert("insert into usersroles (userid,roleid) value(#{userId},#{roleId})")
    ...
    @Select("select id from roles where rolecode=#{value}")
    public int findIdByCode(String  rolecode);
