...
public class GroupBuyQualification implements Serializable {
    ...
    private LocalDateTime confirmtime;       //合同签订时间
    ...
    public GroupBuyQualification(int userid, String status, int clienttype) {
        this.userid = userid;
        this.status = status;
    ...
    public GroupBuyQualification(LocalDateTime confirmtime,String companyname,String userphone,String username,String comment,int id, String groupbuyordercode, String status, BigDecimal margins, String photopath, LocalDateTime lastupdatetime, LocalDateTime createtime, boolean contractverify, boolean isdelete) {
        this.id = id;
