...
public class Demand extends CoalBaseData implements Serializable {
   ...
   /* private boolean isshowcompany;          //是否显示公司信息 1显示,0不显示(废弃)*/
    ...
    // add GV, YV, FC, PS, PSName, ADV02, RV02, FC02, GV02, YV02, paymode, transportmode for constructor
    public Demand(Integer NCV, BigDecimal ADS, BigDecimal RS, BigDecimal TM, BigDecimal IM, BigDecimal ADV, BigDecimal RV, Integer AFT, BigDecimal ASH, Integer HGI, Integer GV, Integer YV, Integer FC, Integer PS, String PSName, int id, int userid, String demandcustomer, String demandcode, String deliveryplace, int demandamount, LocalDate deliverydate, LocalDate deliverydatestart, LocalDate deliverydateend, LocalDateTime releasetime, String deliverymode, String inspectionagency, String checkstatus, String tradestatus, int quotenum, boolean isdelete, int purchasednum, int residualdemand, String deliverydistrict, String deliveryprovince, boolean releasestatus, String comment, String otherorg, String otherplace, LocalDate quoteenddate, LocalDate noshowdate, String coaltype, String tradercode, LocalDateTime checktime, String tradername, String traderphone, Integer regionId, Integer provinceId, Integer portId, int traderid, int viewtimes, String releasecomment, int clienttype, String paymode, String transportmode, BigDecimal ADV02, BigDecimal RV02, Integer FC02, Integer GV02, Integer YV02) {
        super(NCV, ADS, RS, TM, IM, ADV, RV, AFT, ASH, HGI, GV, YV, FC, PS, PSName);
        this.id = id;
        this.userid = userid;
    ...
    public void setOtherorg(String otherorg) {
        this.otherorg = EmojiFilter.filterEmoji(otherorg);
    }
    ...
    public void setOtherplace(String otherplace) {
        this.otherplace = EmojiFilter.filterEmoji(otherplace);;
    }
    ...
    public void setReleasecomment(String releasecomment) {
        this.releasecomment = EmojiFilter.filterEmoji(releasecomment);
    }
