...
public class PriceLadder implements Serializable {
    ...
    public PriceLadder(int squence, BigDecimal price, int amount1, int amount2) {
        this.price = price;
    ...
    public PriceLadder(int sellinfoid, int squence, BigDecimal price, int amount1, int amount2, LocalDateTime createtime, int userid, String username) {
